...
| **Channel × Agent × Team 业务集成** | [业务说明](./需求/17-channel-agent-team-integration.md) · [集成设计](./需求/17-channel-agent-team-integration.design.md) · [Chat 同步](./changelog/2026-05-22-Channel-Chat-Sync.md) · [入站根因](./changelog/2026-05-22-Channel-Inbound-Root-Cause.md) · [审查](./review/2026-05-22-Channel-Inbound-Review.md) · [Channel](./需求/17%20channel.md) | 飞书入站门控、Runtime 双 WS 修复、Web Chat 同步 |
