...
| **M55 Chat×Channel×Cursor 对标** | [**整体方案**](./需求/55-chat-channel-cursor-solution.md) · [**开发计划**](./需求/55-chat-channel-cursor-development.md) · [execution-plan §迭代 CC](./guides/execution-plan.md) · [changelog](./changelog/2026-05-23-Chat-Channel-Cursor-Solution.md) | 长任务双平面（Turn vs Job）；Channel↔Web `session_revision`；TurnBlock UI；Cursor 对标 |
