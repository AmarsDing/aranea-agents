...
CREATE TABLE IF NOT EXISTS llm_provider_models (
  ...
  config_json TEXT NOT NULL DEFAULT '',
  metadata_json TEXT NOT NULL DEFAULT '',
  capability_text INTEGER NOT NULL DEFAULT 0,
  capability_vision INTEGER NOT NULL DEFAULT 0,
  capability_audio INTEGER NOT NULL DEFAULT 0,
  capability_file INTEGER NOT NULL DEFAULT 0,
  capability_tool_call INTEGER NOT NULL DEFAULT 0,
  capability_cache INTEGER NOT NULL DEFAULT 0,
  capability_thinking INTEGER NOT NULL DEFAULT 0,
  capability_text_only INTEGER NOT NULL DEFAULT 0,
  capabilities_explicit INTEGER NOT NULL DEFAULT 0,
  created_at TEXT NOT NULL DEFAULT '',
  updated_at TEXT NOT NULL DEFAULT '',
  deleted_at TEXT NOT NULL DEFAULT ''
);
