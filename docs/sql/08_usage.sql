...
CREATE TABLE IF NOT EXISTS model_pricing_rules (
  ...
  cached_input_price_usd_per_1m REAL NOT NULL DEFAULT 0,
  reasoning_price_usd_per_1m REAL NOT NULL DEFAULT 0,
  embedding_price_usd_per_1m REAL NOT NULL DEFAULT 0,
