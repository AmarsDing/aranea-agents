...
| `company_lead_agent_id` | **已落地（metadata，M78 Phase 4）** | 仅 company 级；对称 `dept_lead`，启发式不可分配；Agent 挂「总经理」岗。见 [重型组织链 ADR](../reports/2026-08-22-review-adr-org-heavy-chain.md) |
