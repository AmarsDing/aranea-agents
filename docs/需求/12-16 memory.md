...
> 完整的组件文件结构、TypeScript 类型定义、API 函数签名、路由配置见 [`12-16 memory.design.md`](./12-16%20memory.design.md) §九。
...
> 具体的 Proto 定义和 TypeScript API 函数签名见 [`12-16 memory.design.md`](./12-16%20memory.design.md) §二/§九。
