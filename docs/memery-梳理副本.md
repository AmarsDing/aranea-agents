...
> **来源**：`docs/memery.md` 全文梳理，不改变原观点，仅做结构化汇总，便于检索与对照。  
> **说明**：原作者声明内容为个人实践与独立思考；涉及近年论文仅供参考；文末保留对 **Latent Memory / C-D 路线** 的延伸阅读指引（正文有意未展开）。  
...
- Zep + Graphiti：**时序知识图谱（TKG）**，边上加 **Temporal Validity** ⇒ 区分「曾经为真」与「当前为真」。【原文插图占位】。  
...
*梳理副本生成自 `docs/memery.md`，若原文更新，建议同步比对命题编号与论文版本。*
