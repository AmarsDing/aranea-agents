...
> **版本**：2026-05-21 | **状态**：✅ API + 指标 + Scanner 首版；🟡 趋势图 / diff / SOUL 自动写文件 / 护栏未通
...
| ID | 优先级 | 待优化项 |
|----|--------|----------|
| EVO-01 | P2 | `evolution_scanner.go` + Wire 启动 + `safego` | ✅ 迭代 10 |
| EVO-02 | P2 | 阈值生成 `EvolutionSuggestion` | ✅ 迭代 10 |
| EVO-03 | P3 | `diff_preview` 生成 |
| EVO-04 | P3 | SOUL.md 自动演化（仅风格段） |
