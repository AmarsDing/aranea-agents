...
| 文档 | 内容 | 来源 |
|------|------|------|
| [architecture.md](./architecture.md) | 模块结构与职责、数据库 Schema、Wire 注入、开发决策树 | `docs/architecture-blueprint.md` |
| [module-cross-reference.md](./module-cross-reference.md) | 指针文件 → `docs/module-cross-reference.md`（模块关联 8 维度卡片） | `docs/module-cross-reference.md` |
...
| `docs/architecture-blueprint.md` | 架构蓝图（含叙述） | 本目录提取结构事实，去除叙述 |
| `docs/module-cross-reference.md` | 模块交叉参考（完整） | 本目录为指针文件，指向原文档 |
