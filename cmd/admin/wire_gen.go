...
func wireApp(confServer *conf.Server, confData *conf.Data, runtime *conf.Runtime, debugRecorder *conf.DebugRecorder, logger log.Logger, loggatewayLogger loggateway.Logger, pipeline logpipeline.Pipeline, arg []*conf.LoggingSink) (wireOut, func(), error) {
	...
	spiritTeamUsecase := provideSpiritTeamUsecase(teamUsecase, v25, agentUsecase, spiritTransactor, orchestrationCache, evolutionSuggestionRepo, verificationGateExecutor, deptLeadManager, stepV2Repo, loggatewayLogger)
	...
	sessionStatusGuard := service.NewSessionStatusGuard(v25, teamUsecase, taskOrchestratorPort, v2Bus, v2RecoveryRepo, loggatewayLogger)
