...
func wireApp(confServer *conf.Server, confData *conf.Data, runtime *conf.Runtime, selfImprovement *conf.SelfImprovement, sandbox *conf.Sandbox, debugRecorder *conf.DebugRecorder, logger log.Logger, loggatewayLogger loggateway.Logger, pipeline logpipeline.Pipeline, arg []*conf.LoggingSink) (wireOut, func(), error) {
	...
	v29 := provideToolUsecaseWithDeps(v2, settingRepo, toolTester, toolWebResearchReadinessChecker, toolGrantRepo, loggatewayLogger)
	...
	graphNodeResolverSet := provideGraphBuildDeps(llmProviderModelUsecase, v29, agentUsecase, agentRepository, systemSettingRepo, v13, persistenceSet, repository, factory, retriever, v35, manager, organizationUsecase, toolResultGate, router, subagentService, v22, nodeCircuitBreakerRegistry, bridge, runtime, loggatewayLogger)
	...
	verificationGateExecutor := provideVerificationGateExecutor(deptLeadManager, dynamicLLMCaller, v13, loggatewayLogger)
	...
	serviceSessionService := service.NewSessionService(v33, v20, sessionRunUsecase, sessionCompressor, sessionCompressor, v32, sessionV2Service, loggatewayLogger)
	...
	v45 := flowlog.NewUsecase(flowlogRepo)
	flowLogService := service.NewFlowLogService(v45)
	codeExecutorService := service.NewCodeExecutorService(factory, loggatewayLogger)
	v46 := provideDiagBundleGenerator(v5, v6, rootCauseEngine)
	...
	v49 := provideMonitorAlertEvalWorker(v20)
	...
	v50 := monitor.ProvideSelfCheckers(dbPinger, v18, v49, eventBusHealthChecker, wsConnectionCounter, v19, v8)
	eventBusResubscriber := provideEventBusResubscriber()
	v51 := monitor.ProvideSelfCheckRepairers(v19, v18, v49, eventBusResubscriber)
	...
	selfCheckScheduler := provideSelfCheckScheduler(v50, v51, selfCheckReportRepo, v16, loggatewayLogger, monitorFlowLogWriter)
	monitorService := service.NewMonitorService(v20, processLogEnabledProvider, flowLogService, codeExecutorService, v46, v48, selfCheckScheduler, selfCheckReportRepo, loggatewayLogger)
	...
	teamService := service.NewTeamService(teamUsecase, graphUsecase, agentUsecase, v33, runner, runRegistryPort, v2Bus, loggatewayLogger, spiritSynthesisService, teamStageV2Repo, stepV2Repo, stepV2Repo, teamRunV2Repo, memberSessionV2Repo, sequencer, v20, v37)
	...
	twinOpenAPICompatService := service.NewTwinOpenAPICompatService(agentUsecase, graphUsecase, memoryAdminUsecase, v37, v20, llmProviderModelUsecase, loggatewayLogger)
	...
	eventBusSideConsumers := provideEventBusSideConsumers(infra, v2Bus, v29, webhookDispatcher, v33, v45, v20, turnMemoryWorker, v18, v19, v37, sessionLogWriter, flowLogWriter)
	...
	flowLogCleanup := provideFlowLogCleanup(v45, loggatewayLogger)
	...
	predictiveHealUsecase := providePredictiveHealUsecase(v20, failurePatternReadWriter, v47, llmProviderModelUsecase, mcpServerUsecase, loggatewayLogger)
