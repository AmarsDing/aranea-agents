<template>
  <q-banner rounded class="monitor-error-banner q-mb-md">
    {{ message }}
    <template #action>
      <q-btn flat dense label="重试" class="monitor-error-banner__action" @click="$emit('retry')" />
    </template>
  </q-banner>
</template>
...
body.body--dark .monitor-error-banner__action
