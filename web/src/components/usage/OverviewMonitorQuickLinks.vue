<template>
  <q-btn-dropdown flat no-caps icon="monitor_heart" label="运维监控" class="overview-monitor-dropdown">
    <q-list dense>
      <q-item v-for="link in links" :key="link.tab" v-close-popup clickable @click="openTab(link.tab)">
