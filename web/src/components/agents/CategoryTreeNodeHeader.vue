<template>
  <div class="category-tree-node row items-center no-wrap full-width">
    ...
    <div class="col min-width-0">
      <div class="row items-center q-gutter-xs no-wrap">
        ...
        <q-chip v-if="!node.enabled" dense square size="sm" class="category-tree-node__status-off">已停用</q-chip>
      </div>
      <div v-if="caption" class="category-tree-node__caption ellipsis">{{ caption }}</div>
    </div>
    <div v-if="!readonly" class="category-tree-node__actions row q-gutter-xs no-wrap items-center">
      <q-toggle
