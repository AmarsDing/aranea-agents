  ...
  <div class="ctx-breakdown" :class="{ 'ctx-breakdown--dark': isDark }">
    ...
    <div class="ctx-breakdown__list">
      <div
        ...
        :key="cat.key"
        class="ctx-breakdown__row row items-center no-wrap"
      >
        ...
        <span class="ctx-breakdown__pct text-caption text-weight-medium">{{ breakdownPercent(cat.estTokens, breakdown.totalPromptTokens) }}</span>
