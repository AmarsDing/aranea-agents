...
const { tab, loading, uploading, selectedId, fileInput, visibleAssets, systemGroups, uploadFromFile } =
  useAvatarPickerDialog({
...
const emptyHint = computed(() =>
  isChannel.value ? '暂无平台图标，请重启后端完成 seed 或上传自定义图标。' : '暂无头像。可以先上传一张本地图片。',
);
