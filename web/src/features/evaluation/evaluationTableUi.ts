...
export const EVAL_TREND_TABLE_COLUMNS: QTableColumn<EvalTrendPoint>[] = [
  ...
  registryCol<EvalTrendPoint>("contains_match_score", "Contains", "contains_match_score", "right", REGISTRY_COL_W.narrow),
...
export const EVAL_COMPARE_TABLE_COLUMNS: QTableColumn<EvalRunComparison>[] = [
  ...
  registryCol<EvalRunComparison>("delta_tool_call_accuracy", "Δ Tool", "delta_tool_call_accuracy", "right", REGISTRY_COL_W.narrow)
];
