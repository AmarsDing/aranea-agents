...
import { messageSourceChipKey, parseMessageSourceMeta } from '../messageSourceMeta';

describe('messageSourceMeta', () => {
  it('parses channel source with platform', () => {
    const meta = parseMessageSourceMeta(JSON.stringify({ source: 'channel', platform: 'feishu' }));
