...
export function resolveA2UIBind(bind: unknown, dataModel: Record<string, unknown>): A2UIBoundValue {
...
export function resolveActionContext(contextArr: unknown, dataModel: Record<string, unknown>): Record<string, unknown> {
