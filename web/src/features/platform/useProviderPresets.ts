...
import { PROVIDER_PRESETS, findModelPreset, findProviderPreset, type ProviderModelPreset } from "../../config/providerPresets";
...
export function useProviderPresets(deps: {
  ...
  const currentProviderPreset = computed(() => findProviderPreset(providerPresetKey.value || deps.providerForm.provider_code));
