...
/** Page-level orchestration for tool detail drawer (store + API live here, not in presentation components). */
export function useToolDetailPanel(tool: Ref<Tool | null>) {
  const $q = useQuasar();
