 ...
 */
export function resolvePublicWebhookOrigin(metadata?: Pick<ChannelMetadata, "public_webhook_origin">): string {
...
export function buildChannelWebhookURL(path: string, metadata?: Pick<ChannelMetadata, "public_webhook_origin">): string {
