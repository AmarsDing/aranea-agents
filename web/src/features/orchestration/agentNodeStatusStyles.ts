...
export const AGENT_NODE_STATUS_STYLES: Record<AgentNodeStatus, { label: string; icon: string }> = {
...
export const DISPLAY_STATUS_STYLES: Record<DisplayStatus, { label: string; icon: string; color: string }> = {
