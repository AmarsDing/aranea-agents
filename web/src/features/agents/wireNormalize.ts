...
export function normalizeAgentFromService(raw: unknown): Agent {
  ...
  return {
    ...
    taxonomy_position_id: pickStr(w, 'categoryPositionId', 'category_position_id'),
...
export function partialAgentToWire(payload: Partial<Agent>): KratosAgentWire {
  ...
  if (payload.taxonomy_position_id !== undefined) o.categoryPositionId = payload.taxonomy_position_id;
