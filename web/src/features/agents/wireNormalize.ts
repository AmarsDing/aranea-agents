import type { Agent, AgentPromptFile, AgentRuntimeSettings, A2AProxyConfig } from './types';
import type {
...
export function normalizeRuntimeSettingsFromWire(raw: unknown): AgentRuntimeSettings | undefined {
  ...
  return {
    ...
    tools_retry_enabled: pickBoolOpt(w, 'toolsRetryEnabled', 'tools_retry_enabled'),
    tools_retry_max_attempts: pickNumOpt(w, 'toolsRetryMaxAttempts', 'tools_retry_max_attempts'),
    tools_retry_initial_interval_ms: pickNumOpt(w, 'toolsRetryInitialIntervalMs', 'tools_retry_initial_interval_ms'),
    tools_retry_backoff_factor: pickNumOpt(w, 'toolsRetryBackoffFactor', 'tools_retry_backoff_factor'),
    tools_retry_max_interval_ms: pickNumOpt(w, 'toolsRetryMaxIntervalMs', 'tools_retry_max_interval_ms'),
    tools_retry_jitter: pickBoolOpt(w, 'toolsRetryJitter', 'tools_retry_jitter'),
    tools_parallel_enabled: pickBoolOpt(w, 'toolsParallelEnabled', 'tools_parallel_enabled'),
    tools_streaming_enabled: pickBoolOpt(w, 'toolsStreamingEnabled', 'tools_streaming_enabled'),
    ...
    l0_snapshot_enabled: pickBoolOpt(w, 'l0SnapshotEnabled', 'l0_snapshot_enabled'),
    ...
    l1_history_enabled: pickBoolOpt(w, 'l1HistoryEnabled', 'l1_history_enabled'),
    ...
    guardrail_rollback_on_decline_percent: pickNum(
      w,
      'guardrailRollbackOnDeclinePercent',
      'guardrail_rollback_on_decline_percent',
      20,
    ),
    ...
    ralph_loop_verify_timeout_seconds: pickNumOpt(
      w,
      'ralphLoopVerifyTimeoutSeconds',
    ...
    micro_compact_enabled: pickBoolOpt(w, 'microCompactEnabled', 'micro_compact_enabled'),
    ...
    compression_buffer_ratio: pickNumOpt(w, 'compressionBufferRatio', 'compression_buffer_ratio'),
    soft_trigger_ratio: pickNumOpt(w, 'softTriggerRatio', 'soft_trigger_ratio'),
    hard_trigger_ratio: pickNumOpt(w, 'hardTriggerRatio', 'hard_trigger_ratio'),
...
export function runtimeSettingsToWire(s: AgentRuntimeSettings): KratosRuntimeWire {
  return {
    ...
    l0SnapshotEnabled: s.l0_snapshot_enabled,
    l1Enabled: s.l1_enabled,
    l1HistoryEnabled: s.l1_history_enabled,
    ...
    microCompactEnabled: s.micro_compact_enabled,
    memoryCompactEnabled: s.memory_compact_enabled,
    toolResultGateEnabled: s.tool_result_gate_enabled,
    toolsCircuitBreakerEnabled: s.tools_circuit_breaker_enabled,
    toolsCircuitBreakerOverridesJson: s.tools_circuit_breaker_overrides_json,
    toolsDeferredJson: s.tools_deferred_json,
    toolsCommandSafetyEnabled: s.tools_command_safety_enabled,
    ...
    compressionBufferRatio: s.compression_buffer_ratio,
    softTriggerRatio: s.soft_trigger_ratio,
    hardTriggerRatio: s.hard_trigger_ratio,
