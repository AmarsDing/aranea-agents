...
export function buildRuntimeSettingsPayload(
  ...
  return {
    ...
    l3_pii_policy: config.memoryL3.pii_policy,
    ...
    l4_decay_interval_hours: config.memoryL4.decay_interval_hours,
    l4_decay_overrides_json: config.memoryL4.decay_overrides_json,
