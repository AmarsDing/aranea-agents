...
/** MemoryCascadePanel 列定义 */
export const MEMORY_CASCADE_TABLE_COLUMNS: QTableColumn<CascadeProposal>[] = [
...
export function buildMemoryAssemblyTableColumns(formatDate: (value: string) => string) {
  return [
    ...
    registryCol<L0AssemblySnapshot>("segments", "段落", "segments_json", "left", REGISTRY_COL_W.category, { sortable: false }),
