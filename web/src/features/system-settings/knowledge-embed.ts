...
import {
  DEFAULT_KNOWLEDGE_EMBED_FORM,
  type KnowledgeEmbedFormState
} from "../knowledge/embedder-constants";

export function knowledgeEmbedFromSettings(
  embed?: KnowledgeEmbedSettings | null
): KnowledgeEmbedFormState {
