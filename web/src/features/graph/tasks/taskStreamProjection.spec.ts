...
import { applyTaskStatusMetadata, seedTaskMap, tasksToList, wsTaskStatusToTaskStatus } from './taskStreamProjection';
...
describe('taskStreamProjection', () => {
  ...
  it('sorts tasks by node id', () => {
    const map = seedTaskMap([{ ...emptyTask('t2', 'e1', 'b') }, { ...emptyTask('t1', 'e1', 'a') }]);
