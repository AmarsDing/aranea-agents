...
export function createArtifactServiceClient(
  ...
  return {
    ...
    DeleteArtifactVersion(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      // NOTE: hand-patched — artifact versions are 0-based, so version=0 is a
      // legitimate value; the generator's falsy guard wrongly rejected it.
      // Re-apply if this file is regenerated by protoc-gen-typescript-http.
