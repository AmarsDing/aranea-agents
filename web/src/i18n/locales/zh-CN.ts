export default {
  ...
  channelEditor: {
    ...
    routingAgentModelFail: "模型不可用（{provider} / {model}）：{detail}。飞书/Web 消息可能失败，请在 Agent 设置或模型管理中修正。",
  ...
  hooksPage: {
    ...
    callbackEditor: {
      ...
      fieldLogLevel: "日志级别",
      fieldMessage: "消息",
      modifyPatchHint: "before_model：generation_config / append_system / append_user。before_tool：arguments 整包替换；merge_arguments 深度合并（嵌套对象递归，标量/数组以 patch 为准）。",
