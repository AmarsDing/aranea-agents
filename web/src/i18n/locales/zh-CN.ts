export default {
  ...
  industries: {
    market: {
      ...
      title: '行业模板库',
      subtitle:
        '一个行业即一个完整场景包 — 内置岗位级 Agent、部门职责、领域 Tool/Skill/Knowledge。选择行业，一键安装，立刻拥有可协作的智能团队。',
      actionRefresh: '刷新',
      actionExport: '导出清单',
      actionRequestNew: '申请新行业',
      metricEnabled: '已启用行业',
      metricEnabledDelta: '+1',
      metricEnabledFoot: '本月新增 {delta}',
      metricEnabledFootNoDelta: '本月新增',
      metricDepartments: '部门总数',
      metricDepartmentsFoot: '跨所有已启用行业',
      metricPositions: '岗位总数',
      metricPositionsFoot: '人均 {ratio} Agent / 岗',
      metricAgents: 'Agent 总数',
      metricAgentsFoot: '已部署实例 {installed}',
      ...
      cardViewDepts: '查看部门',
      ctaTitle: '申请新行业',
      ctaSubtitle: '描述你的业务场景<br />平台团队会评估并发布',
      emptyTitle: '没有匹配的行业模板',
      emptyHint: '尝试调整搜索词或清除筛选条件',
      drawerClose: '关闭',
      drawerSectionDepts: '部门与岗位',
      drawerLoadingDepts: '正在加载部门…',
      drawerNoDepts: '该行业暂无部门数据',
      drawerActionViewPrompts: '查看 Prompt 模板',
      drawerActionInstall: '安装行业',
  ...
  organization: {
    market: {
      ...
      title: '公司架构',
      subtitle:
        '一个公司即一个完整组织包 — 内置岗位级 Agent、部门职责、领域 Tool/Skill/Knowledge。选择公司架构，一键安装，立刻拥有可协作的智能团队。',
      actionRefresh: '刷新',
      actionExport: '导出清单',
      actionRequestNew: '申请新公司',
      metricEnabled: '已启用公司',
      metricEnabledDelta: '+1',
      metricEnabledFoot: '本月新增 {delta}',
      metricEnabledFootNoDelta: '本月新增',
      metricDepartments: '部门总数',
      metricDepartmentsFoot: '跨所有已启用公司',
      metricPositions: '岗位总数',
      metricPositionsFoot: '人均 {ratio} Agent / 岗',
      metricAgents: 'Agent 总数',
      metricAgentsFoot: '已部署实例 {installed}',
      searchPlaceholder: '搜索公司名称 / key / 描述…',
      searchKbd: '⌘ K',
      statusAll: '全部',
      statusEnabled: '启用',
      statusDisabled: '停用',
      ...
      ctaTitle: '申请新公司',
      ctaSubtitle: '描述你的业务场景<br />平台团队会评估并发布',
      emptyTitle: '没有匹配的公司架构',
      emptyHint: '尝试调整搜索词或清除筛选条件',
      drawerClose: '关闭',
      drawerSectionDepts: '部门与岗位',
      drawerLoadingDepts: '正在加载部门…',
      drawerNoDepts: '该公司暂无部门数据',
      drawerActionViewPrompts: '查看 Prompt 模板',
      drawerActionInstall: '安装公司',
      signatureQuote: '"Spec the world, then ship it."',
      signatureCaption: '· 信息建筑派的签名细节 — 每个数字可被追溯、每个选项可被对比',
      noMetricHint: '—',
      tableDesc: '描述',
