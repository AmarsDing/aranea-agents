export default {
  ...
  chat: {
    ...
    executionReport: {
      title: 'Task Execution Summary Report',
      statusCompleted: 'Completed',
      statusPartialFailure: 'Partial Failure',
      statusFailed: 'Failed',
      tokenSummary: 'token {tokenIn}↑/{tokenOut}↓',
      degradedHint: 'Analysis conclusion generation failed; showing structured execution data',
      teamResults: 'Step Results ({count})',
