export default {
  ...
  knowledgePage: {
    ...
    dropzoneHint:
      'Supports txt / md / json / csv / html / xml / yaml / pdf / doc / docx / xlsx / pptx; content is organized into Markdown on ingest',
    ...
    uploadImageUnsupported: 'Image ingest (multimodal) is not available yet',
