export default {
  ...
  memory: {
    ...
    overview: {
      ...
      layers: {
        l0Title: 'Context Window L0',
        l0Caption: 'Material the next model call actually sees.',
        l1Title: 'Working Memory L1',
        l1Caption: 'Current task goals, constraints, decisions, and intermediate results.',
        l2Title: 'Event Memory L2',
        l2Caption: 'Session timeline, episodes, marks, and consolidation queue.',
        l3Title: 'Knowledge Memory L3',
        l3Caption: 'Cross-session facts, preferences, rules, conflicts, and feedback.',
        l4Title: 'Graph & Evolution L4',
        l4Caption: 'Entity relations, Agent identity, strategy, and proposals.',
      },
      status: {
        connected: 'Connected',
      ...
      actions: {
        contextNearLimit: 'Context Near Limit',
        contextNearLimitCaption: 'Check summary threshold and injected segment count.',
        knowledgeConflict: 'Knowledge Conflicts',
        knowledgeConflictCaption: 'Facts needing arbitration after L3 conflict API integration.',
        pendingEvolution: 'Pending Evolution Proposals',
        pendingEvolutionCaption: 'From Agent Evolution proposal queue.',
        cascadeRename: 'Cascade Rename Review',
        cascadeRenameCaption: 'Graph/L3 cascade review from L4 conflict gating.',
      },
    },
    cascade: {
