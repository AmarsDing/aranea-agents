export default {
  ...
  skillsPage: {
    ...
    ecosystemPublishMessage: 'Publish skill "{name}" to the ecosystem market? Other users can search and install it.',
  ...
  monitorPage: {
    ...
    alerts: {
      title: 'Alert Rules',
      subtitle: 'An alert fires when a metric reaches its threshold within the evaluation window, and is delivered via the configured notification method',
      add: 'Add Rule',
      refresh: 'Refresh',
      save: 'Save',
      ...
      rule: {
        ...
        notifyHint: 'Set at least a Webhook or a channel to send notifications; with both empty the alert is only recorded in Events',
        delete: 'Delete',
        enabled: 'Enabled',
        state: {
          ok: 'OK',
      ...
      metrics: {
        runner_error_rate: {
          ...
          description: 'Share of failed chat/team runs within the window (0-1). A rising value means many runs are failing.',
        },
        ...
        sequencer_dead_letter_count: {
          ...
          description: 'Activity events that could not be persisted even after retries. Above 0 means permanent event loss.',
        },
        monitor_selfcheck_unhealthy_count: {
          name: 'Unhealthy self-checks',
          description: 'Number of subsystem self-checks currently failing (database, event bus, WebSocket, trace projector, etc.).',
        },
      },
    },
  },
  ...
  knowledgePage: {
    ...
    searchHintHybrid: 'Mode: auto-routes among vector / full-text / hybrid (RRF)',
    searchHintRewrite: 'Rewrite: LLM rewrites the query for better recall',
    searchHintRerank: 'Rerank: re-orders candidates for precision',
    ...
    searchScopeAll: 'All collections',
    moveTo: 'Move to…',
