export default {
  ...
  industries: {
    market: {
      ...
      subtitle: 'Each industry is a complete scenario pack — built-in position-level Agents, department responsibilities, domain Tools / Skills / Knowledge. Pick an industry, install in one click, get a working team instantly.',
