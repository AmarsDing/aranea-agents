export default {
  ...
  industries: {
    market: {
      ...
      subtitle:
        'Each industry is a complete scenario pack — built-in position-level Agents, department responsibilities, domain Tools / Skills / Knowledge. Pick an industry, install in one click, get a working team instantly.',
      actionRefresh: 'Refresh',
      actionExport: 'Export list',
      actionRequestNew: 'Request new industry',
      metricEnabled: 'Enabled industries',
      metricEnabledDelta: '+1',
      metricEnabledFoot: '{delta} new this month',
      metricEnabledFootNoDelta: 'new this month',
      metricDepartments: 'Total departments',
      metricDepartmentsFoot: 'across all enabled industries',
      metricPositions: 'Total positions',
      metricPositionsFoot: '{ratio} agents per position (avg)',
      metricAgents: 'Total Agents',
      metricAgentsFoot: '{installed} installed instances',
      searchPlaceholder: 'Search name / key / description…',
      searchKbd: '⌘ K',
      statusAll: 'All',
      ...
      cardViewDepts: 'View departments',
      ctaTitle: 'Request new industry',
      ctaSubtitle: 'Describe your business scenario<br />Our team will evaluate and publish',
      emptyTitle: 'No matching industry templates',
      emptyHint: 'Try adjusting your search or clearing filters',
      drawerClose: 'Close',
      drawerSectionDepts: 'Departments & positions',
      drawerLoadingDepts: 'Loading departments…',
      drawerNoDepts: 'No departments defined yet',
      drawerActionViewPrompts: 'View Prompt templates',
      drawerActionInstall: 'Install industry',
      signatureQuote: '"Spec the world, then ship it."',
      signatureCaption:
        '· Signature of the information architecture school — every number is traceable, every option is comparable',
      noMetricHint: '—',
  ...
  organization: {
    market: {
      ...
      title: 'Organization',
      subtitle:
        'Each company is a complete organization pack — built-in position-level Agents, department responsibilities, domain Tools / Skills / Knowledge. Pick a company, install in one click, get a working team instantly.',
      actionRefresh: 'Refresh',
      actionExport: 'Export list',
      actionRequestNew: 'Request new company',
      metricEnabled: 'Enabled companies',
      metricEnabledDelta: '+1',
      metricEnabledFoot: '{delta} new this month',
      metricEnabledFootNoDelta: 'new this month',
      metricDepartments: 'Total departments',
      metricDepartmentsFoot: 'across all enabled companies',
      metricPositions: 'Total positions',
      metricPositionsFoot: '{ratio} agents per position (avg)',
      metricAgents: 'Total Agents',
      metricAgentsFoot: '{installed} installed instances',
      ...
      metricInstalled: 'Installed',
      cardViewDepts: 'View departments',
      ctaTitle: 'Request new company',
      ctaSubtitle: 'Describe your business scenario<br />Our team will evaluate and publish',
      emptyTitle: 'No matching organization templates',
      emptyHint: 'Try adjusting your search or clearing filters',
      drawerClose: 'Close',
      drawerSectionDepts: 'Departments & positions',
      drawerLoadingDepts: 'Loading departments…',
      drawerNoDepts: 'No departments defined yet',
      drawerActionViewPrompts: 'View Prompt templates',
      drawerActionInstall: 'Install company',
      signatureQuote: '"Spec the world, then ship it."',
      signatureCaption:
        '· Signature of the information architecture school — every number is traceable, every option is comparable',
      noMetricHint: '—',
