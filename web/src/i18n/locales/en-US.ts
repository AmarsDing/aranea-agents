export default {
  ...
  knowledgePage: {
    ...
    emptyTitle: 'Drop files to get started',
    emptyHint:
      'No need to create a collection first — dropped files land in the "Default collection" and can be organized later.',
  ...
  overviewPage: {
    ...
    fallbackEventsCaption: 'Filtered from anomaly usage events: failed / timeout / retries (not full failover metadata)',
