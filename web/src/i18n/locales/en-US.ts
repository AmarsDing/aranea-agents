export default {
  ...
  artifact: {
    page: {
      ...
      filterSession: 'Filter by session ID',
      searchPlaceholder: 'Search name / MIME / session',
      reset: 'Reset',
      refresh: 'Refresh',
      sessionRequiredTitle: 'Enter a session ID',
      sessionRequiredHint: 'Provide a session ID to view its artifacts, or switch to "All artifacts".',
      ...
      loadFailed: 'Load failed',
      uploadNeedSession: 'Session ID is required',
