export default {
  ...
  memory: {
    ...
    graph: {
      ...
      emptyEntities: 'Select an Agent to load L4 entities.',
      bfsTitle: 'Neighborhood BFS',
      hopsLabel: 'Hops',
      expand: 'Expand',
      spreading: 'Spreading',
      spreadingTooltip: 'Run spreading activation from the selected center node; highlights Top-K activated nodes',
      centerLabel: 'Center: {name}',
      nodesEdges: '{nodes} nodes · {edges} edges',
      activatedNodes: 'activated {count} nodes',
      emptyGraph: 'Click an entity on the left, or expand the neighborhood graph with Hops.',
      activationTitle: 'Activation Path Explanation',
      hopLabel: 'hop={count}',
      pathLabel: 'path:',
      centerNode: 'center node (direct activation)',
      confidence: {
        high: 'High',
        medium: 'Medium',
        low: 'Low',
      },
      loadFailed: 'Failed to load neighborhood',
      activationFailed: 'Spreading activation failed',
    },
    recall: {
  ...
  graphs: {
    ...
    engineBSPHint: 'Bulk Synchronous Parallel: synchronized superstep scheduling with checkpoint and interrupt recovery support',
    engineDAGHint: 'Directed Acyclic Graph: parallel execution of independent nodes, better performance but no checkpoint support',
  ...
  artifact: {
    page: {
      ...
      sessionRequiredHint: 'Pick a session from the dropdown (or type a session ID) to view its artifacts, or switch to "All artifacts".',
      untitledSession: 'Untitled session',
