...
function Test-Tool($id, $innerArgsJson, $desc) {
    Write-Host "Testing: $desc ..." -ForegroundColor Cyan
    # Build body with properly escaped inner JSON
...
$results += Test-Tool "tool_patch_file" '{"file_name":"_test_tool_output.txt","patch":"--- a/test\n+++ b/test\n@@ -1 +1 @@\n-hello\n+patched"}' "patch_file"
