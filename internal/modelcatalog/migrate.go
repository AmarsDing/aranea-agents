...
// MigrationPreviewItem describes one legacy→catalog provider migration.
...
// MigrationPreview summarizes pending provider renames.
type MigrationPreview struct {
	Items []MigrationPreviewItem
}

// PreviewMigration counts bindings that would be updated for each legacy provider id.
