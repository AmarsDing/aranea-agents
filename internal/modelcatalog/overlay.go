...
// RuntimeProfile maps models.dev provider id to trpc runtime fields.
...
// ProviderMigration maps legacy provider_code to models.dev id (built-in; shipped with releases).
...
func CountProviders(cat Catalog, q string) int {
...
func ListProviders(cat Catalog, q string, limit, offset int) []Provider {
	if limit <= 0 {
		limit = 200
	}
	if offset < 0 {
