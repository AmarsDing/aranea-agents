...
func TestInferDomainPath_PackPositions(t *testing.T) {
	cases := []struct {
		...
		{"ops_network_inspection", "inspection", "网络巡检专家", "运维/巡检"},
		{"ops_fault_diagnosis", "diagnostics", "故障诊断 Agent", "运维/诊断"},
		{"ops_doc_generation", "docs", "文档生成 Agent", "办公/文档"},
		{"ops_alarm_handler", "alert_response", "告警处理 Agent", "运维/告警"},
