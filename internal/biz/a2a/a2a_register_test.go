...
func TestValidateAuthConfig(t *testing.T) {
	tests := []struct {
		...
		{
			name:           "bearer_valid_with_api_key_fallback",
			authType:       "bearer",
			authConfigJSON: `{"api_key":"my-secret-token"}`,
		},
		{
		...
		{
			name:           "basic_no_longer_supported",
			authType:       "basic",
		...
		{
			name:           "api_key_valid_with_api_key_field",
			authType:       "api_key",
			authConfigJSON: `{"api_key":"my-key"}`,
		},
		{
			name:           "api_key_valid_with_token_fallback",
			authType:       "api_key",
			authConfigJSON: `{"token":"my-key"}`,
		},
		{
			name:           "api_key_valid_with_header_name",
			authType:       "api_key",
			authConfigJSON: `{"api_key":"my-key","header_name":"X-Custom-Key"}`,
		},
		{
			name:           "api_key_missing_api_key_and_token",
			authType:       "api_key",
			authConfigJSON: `{"header_name":"X-Api-Key"}`,
			wantErr:        true,
			wantCode:       400,
		},
		{
		...
		},
		{
			name:           "mtls_valid",
			authType:       "mtls",
			authConfigJSON: `{"cert_file":"/certs/client.crt","key_file":"/certs/client.key"}`,
		},
		{
			name:           "mtls_valid_with_ca",
			authType:       "mtls",
			authConfigJSON: `{"cert_file":"/certs/client.crt","key_file":"/certs/client.key","ca_file":"/certs/ca.crt"}`,
		},
		{
			name:           "mtls_missing_cert_file",
			authType:       "mtls",
			authConfigJSON: `{"key_file":"/certs/client.key"}`,
			wantErr:        true,
			wantCode:       400,
		},
		{
			name:           "mtls_missing_key_file",
			authType:       "mtls",
			authConfigJSON: `{"cert_file":"/certs/client.crt"}`,
			wantErr:        true,
			wantCode:       400,
		},
		{
			name:           "mtls_invalid_json",
			authType:       "mtls",
			authConfigJSON: "{bad",
			wantErr:        true,
			wantCode:       400,
...
func TestRegisterRemoteAgent_InvalidAuth(t *testing.T) {
	tests := []struct {
		...
		{
			name: "mtls_missing_key_file_returns_error",
			input: RegisterRemoteAgentInput{
				Workspace:      "ws-1",
				RemoteURL:      "https://remote.example.com",
				AuthType:       "mtls",
