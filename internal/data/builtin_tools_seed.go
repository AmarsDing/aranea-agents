...
var builtinPlatformToolSeeds = []platformToolSeed{
	...
	{key: "assess_complexity", displayName: "评估任务复杂度", description: "评估用户消息的任务复杂度，根据复杂度选择合适的处理路径。", category: "spirit", source: "builtin", riskLevel: "low", enabled: true, readonly: true, paramsSchema: `{"type":"object","properties":{"user_message":{"type":"string","description":"用户消息内容"}},"required":["user_message"]}`},
