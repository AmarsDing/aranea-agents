...
const (
	// Label holds the string label denoting the platformchannel type in the database.
	Label = "platform_channel"
	...
	// Table holds the table name of the platformchannel in the database.
	Table = "channel"
)

// Columns holds all SQL columns for platformchannel fields.
var Columns = []string{
	FieldID,
	FieldChannelKey,
	FieldName,
...
var (
	// ChannelKeyValidator is a validator for the "channel_key" field. It is called by the builders before save.
	ChannelKeyValidator func(string) error
...
// OrderOption defines the ordering options for the PlatformChannel queries.
