...
func (Agent) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Enum("kind").Values("user", "system_builtin", "ecosystem_preset", "marketplace", "certified").Default("user").Comment("agent kind: user | system_builtin | ecosystem_preset | marketplace | certified"),
