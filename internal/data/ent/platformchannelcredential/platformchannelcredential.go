...
const (
	// Label holds the string label denoting the platformchannelcredential type in the database.
	Label = "platform_channel_credential"
	...
	// Table holds the table name of the platformchannelcredential in the database.
	Table = "channel_credential"
)

// Columns holds all SQL columns for platformchannelcredential fields.
var Columns = []string{
	FieldID,
	FieldChannelID,
	FieldCredentialKey,
...
// OrderOption defines the ordering options for the PlatformChannelCredential queries.
