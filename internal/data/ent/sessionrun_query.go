...
func (_q *SessionRunQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SessionRunQuery) FirstIDX(ctx context.Context) string {
...
func (_q *SessionRunQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *SessionRunQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *SessionRunQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *SessionRunQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SessionRunQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(sessionrun.Table, sessionrun.Columns, sqlgraph.NewFieldSpec(sessionrun.FieldID, field.TypeString))
	_spec.From = _q.sql
