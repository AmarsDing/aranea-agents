...
const (
	// Label holds the string label denoting the planboardv2 type in the database.
	Label = "plan_board_v2"
	...
	// Table holds the table name of the planboardv2 in the database.
	Table = "plan_boards_v2"
)

// Columns holds all SQL columns for planboardv2 fields.
var Columns = []string{
	FieldID,
	FieldTaskID,
	FieldTurnID,
...
// OrderOption defines the ordering options for the PlanBoardV2 queries.
