...
const (
	// Label holds the string label denoting the membersessionv2 type in the database.
	Label = "member_session_v2"
	...
	FieldError = "error"
	// Table holds the table name of the membersessionv2 in the database.
	Table = "member_sessions_v2"
)

// Columns holds all SQL columns for membersessionv2 fields.
var Columns = []string{
	FieldID,
	FieldTeamRunID,
	FieldTeamStageID,
...
// OrderOption defines the ordering options for the MemberSessionV2 queries.
