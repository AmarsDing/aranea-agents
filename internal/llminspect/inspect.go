// Package llminspect implements provider model metadata inspection (ported from pkg/backend PlatformService).
package llminspect
...
// Result matches legacy InspectProviderModelResult JSON.
type Result struct {
	OK                            bool
	Message                       string
	ProviderCode                  string
