...
func toProtoRuntime(b *biz.AgentRuntimeSettings) *v1.AgentRuntimeSettings {
	...
	return &v1.AgentRuntimeSettings{
		...
		L0CompressProvider:                b.L0CompressProvider,
		L0CompressModel:                   b.L0CompressModel,
		MemoryWorkerProvider:              b.MemoryWorkerProvider,
		MemoryWorkerModel:                 b.MemoryWorkerModel,
