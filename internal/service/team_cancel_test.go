...
func TestCancelTeamRun_PublishesCancelledRunStatus(t *testing.T) {
	...
	svc := NewTeamService(biz.NewTeamUsecase(biz.TeamUsecaseOpts{Reader: repo, Writer: repo, RunReader: repo, RunWriter: repo, StepRepo: repo, DeadLetter: repo, Lg: loggateway.NewNoop()}), nil, nil, nil, nil, reg, bus, loggateway.NewNoop(), nil, nil, nil, nil, nil, nil, nil, nil, nil)
