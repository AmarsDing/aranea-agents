...
func (s *SessionService) BatchArchiveSessions(ctx context.Context, req *v1.BatchArchiveSessionsRequest) (*v1.BatchSessionsResponse, error) {
	...
	recordAudit(ctx, s.mon, biz.AdminAuditEntry{
		...
		Resource: "session",
		Summary: fmt.Sprintf("matched=%d processed=%d skipped_running=%d skipped_not_found=%d truncated=%v",
...
func (s *SessionService) BatchDeleteSessions(ctx context.Context, req *v1.BatchDeleteSessionsRequest) (*v1.BatchSessionsResponse, error) {
	...
	recordAudit(ctx, s.mon, biz.AdminAuditEntry{
		...
		Resource: "session",
		Summary: fmt.Sprintf("matched=%d processed=%d skipped_running=%d skipped_not_found=%d truncated=%v include_archived=%v",
