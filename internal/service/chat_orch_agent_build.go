...
func (d *chatAgentBuildDirector) BuildTRPCDeps(ctx context.Context, p AgentBuildParams) (chatagent.TRPCBuilderDeps, error) {
	...
	deps := chatagent.TRPCBuilderDeps{
		...
		TRPCToolAssemblyDeps: chatagent.TRPCToolAssemblyDeps{
			...
			KanbanBridge:         d.rt.Bridges.Kanban,
			ComputerUseUC:        d.rt.Bridges.ComputerUse,
			CodingBridgeSvc:      d.rt.Bridges.Coding,
			SandboxFSStore:       d.rt.Bridges.SandboxFS,
		...
		TRPCMemoryKnowledgeDeps: chatagent.TRPCMemoryKnowledgeDeps{
			...
			MemoryLayerPorts:       d.td.Persist.Memory.MemoryLayerPorts,
		...
		TRPCSkillDeps: chatagent.TRPCSkillDeps{
			...
			SkillDBRepo:         d.rt.Skill.DBRepo,
			CodeExecFactory:     d.rt.Skill.CodeExecFactory,
			SkillHealthProvider: d.rt.Skill.healthProvider(),
		},
		TRPCExtensionDeps: chatagent.TRPCExtensionDeps{
			Organization:     d.rt.Extensions.Organization,
			ToolResultGate:   d.rt.Extensions.ToolResultGate,
			ToolResultPrune:  d.rt.Extensions.ToolResultPrune,
			SubAgentService:  d.subAgentSvc,
			OutboundRouter:   d.outboundRouter,
			ClientBridge:     d.rt.Bridges.Client,
