...
func (s *stubExpReportReader) ListFiltered(_ context.Context, _ string, _, _ *time.Time, _, _ int) ([]biz.ExperienceReport, int, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func TestSkillIntelligenceIntegration_AnalyzeInvocation(t *testing.T) {
	uc := biz.NewSkillIntelligenceUsecase(nil, nil, nil, nil, nil, nil, nil, loggateway.NewNoop())
...
func TestSkillIntelligenceIntegration_GenerateReport(t *testing.T) {
	t.Run("SuccessInvocation_ReportPersisted", func(t *testing.T) {
		...
		uc := biz.NewSkillIntelligenceUsecase(reader, writer, nil, aggregator, nil, nil, nil, loggateway.NewNoop())
...
func TestSkillIntelligenceIntegration_ScoreSkill(t *testing.T) {
	t.Run("HighSuccessRate_HighScore", func(t *testing.T) {
		...
		uc := biz.NewSkillIntelligenceUsecase(nil, nil, nil, aggregator, nil, nil, nil, loggateway.NewNoop())
...
func TestSkillIntelligenceIntegration_EvolutionSuggestions(t *testing.T) {
	t.Run("CreateAndApproveSuggestion", func(t *testing.T) {
		...
		uc := biz.NewSkillIntelligenceUsecase(nil, nil, nil, nil, sugReader, sugWriter, nil, loggateway.NewNoop())
...
func TestSkillIntelligenceIntegration_CheckEvolutionTriggers(t *testing.T) {
	...
	t.Run("HighFailureRate_TriggersFixFailureSuggestion", func(t *testing.T) {
		...
		uc := biz.NewSkillIntelligenceUsecase(nil, nil, nil, aggregator, sugReader, sugWriter, nil, loggateway.NewNoop())
