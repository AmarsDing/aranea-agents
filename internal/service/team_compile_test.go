...
func (r *compileTeamRepo) CountTeamsByWorkspace(_ context.Context, _ string) (int, error) {
	return 0, nil
}
...
func TestCompileTeamGraph_sequential(t *testing.T) {
	...
	svc := NewTeamService(biz.NewTeamUsecase(biz.TeamUsecaseOpts{Reader: repo, Writer: repo, RunReader: repo, RunWriter: repo, StepRepo: repo, DeadLetter: repo, Lg: loggateway.NewNoop()}), nil, nil, nil, nil, nil, nil, loggateway.NewNoop(), nil, nil, nil, nil, nil, nil, nil, nil, nil)
