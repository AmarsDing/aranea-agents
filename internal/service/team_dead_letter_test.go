...
func (r *deadLetterTeamRepo) CreateTeamRun(context.Context, biz.TeamRun) (biz.TeamRun, error) {
...
func TestTeamService_ListTaskDeadLetters_requiresScope(t *testing.T) {
	svc := NewTeamService(biz.NewTeamUsecase(biz.TeamUsecaseOpts{Reader: &deadLetterTeamRepo{}, Writer: &deadLetterTeamRepo{}, RunReader: &deadLetterTeamRepo{}, RunWriter: &deadLetterTeamRepo{}, StepRepo: &deadLetterTeamRepo{}, DeadLetter: &deadLetterTeamRepo{}, Lg: loggateway.NewNoop()}), nil, nil, nil, nil, nil, nil, loggateway.NewNoop(), nil, nil)
