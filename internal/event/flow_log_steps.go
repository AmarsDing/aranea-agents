...
// 红线（52-flow-logger.design.md §5.1）：新增发射点必须同步登记本表与设计文档。
var stepTitleRegistry = map[string]string{
	...
	"team.run.crash_resume":                "崩溃续跑",
	"team.run.crash_resume_fail":           "崩溃续跑失败回退",
	"team.run.orphan_finalize":             "孤儿运行终结",
	...
	"codeexec.backend_fallback":            "代码执行后端降级",
	"team.member":                          "团队成员执行",
