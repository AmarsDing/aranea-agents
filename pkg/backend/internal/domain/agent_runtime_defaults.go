...
// DefaultAgentRuntimeSettings returns the built-in default for a new or missing
// agent_runtime_settings row. Kept in domain so Capability and service layers
