// Package catalog is the Catalog bounded Context: agents, agent versions,
// avatars, evolution proposals, and prompt assets.
//
...
// Module is the Catalog Context shell; it implements module.Module.
type Module struct{}

// NewModule constructs the Catalog module.
