...
type AddMemoryRequest struct {
	Memory       string   `json:"memory" jsonschema:"description=The memory content to store. Should be a brief third-person statement that captures key information about the user,required"`
...
type UpdateMemoryRequest struct {
	MemoryID     string   `json:"memory_id" jsonschema:"description=The ID of the memory to update,required"`
	Memory       string   `json:"memory" jsonschema:"description=The updated memory content,required"`
	Topics       []string `json:"topics,omitempty" jsonschema:"description=Optional topics for categorizing the memory"`
...
type DeleteMemoryRequest struct {
	MemoryID string `json:"memory_id" jsonschema:"description=The ID of the memory to delete,required"`
}
