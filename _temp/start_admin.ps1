...
$proc = Start-Process -FilePath "F:\aranea-agents\admin.exe" -ArgumentList "-conf","F:\aranea-agents\configs\config.yaml" -RedirectStandardOutput $outFile -RedirectStandardError $errFile -PassThru -WindowStyle Hidden
